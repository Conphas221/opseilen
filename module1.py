...
class Rects:
    def __init__(self,game):
        self.Game = game
    def draw(self,screen):
        mc_button = pygame.draw.rect(screen,purple,(0.1*self.Game.width,0.1*self.Game.height,0.3*self.Game.width,25)) # mc question button
        open_button = pygame.draw.rect(screen,green,(0.1*self.Game.width,0.2*self.Game.height,0.3*self.Game.width,25)) #open question button
        quit_button = pygame.draw.rect(screen,blue,(0.1*self.Game.width,0.3*self.Game.height,0.3*self.Game.width,25)) #place to draw quit button (quit doesn't work yet)
        dice_button = pygame.draw.rect(screen,red,(0.1*self.Game.width,0.4*self.Game.height,0.3*self.Game.width,25)) #place to draw button to roll a die
        quest_field = pygame.draw.rect(screen,black,(0.1*self.Game.width,0.6*self.Game.height,0.4*self.Game.width,25)) # place to draw question
        mc_field = pygame.draw.rect(screen,black,(0.1*self.Game.width,0.7*self.Game.height,0.4*self.Game.width,25)) #place to draw mc options
        was_question_correct_rect = pygame.draw.rect(screen,black,(0.1*self.Game.width,0.8*self.Game.height,0.4*self.Game.width,25))  #place to draw "wrong answer' or 'correct' message
